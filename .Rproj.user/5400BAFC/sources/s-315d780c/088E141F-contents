...
for (i in Alle){
  for (y in c(1:3)){
    png(file=paste("~/", colnames(i[y]), "0_25.png", sep=""),
        width=600, height=350)
    hist(i[[y]], breaks = breaks, main = paste("Histogramm von" , colnames(i[y])), xlab = colnames(i[y]), ylab = "Häufigkeit")
    dev.off()
  }
...
#Histogram für Agency (Manuell, da Loop nicht funktioniert hat)
png(file="AgencyNA.png",
    width=600, height=350)
hist(Agency$AgencyNA, breaks = breaks, main = "Histogramm von AgencyNA", xlab = "AgencyNA", ylab = "Häufigkeit")
dev.off()
png(file="AgencyWA.png",
    width=600, height=350)
hist(Agency$AgencyWA, breaks = breaks, main = "Histogramm von AgencyWA", xlab = "AgencyWA", ylab = "Häufigkeit")
dev.off()
png(file="AgencySA.png",
    width=600, height=350)
hist(Agency$AgencySA, breaks = breaks, main = "Histogramm von AgencySA", xlab = "AgencySA", ylab = "Häufigkeit")
dev.off()

#Boxplots

plots <- list()
plots[[1]] <- ggboxplot(stack(Anthro1), x = "ind", y = "values", add.params = list(color = "grey50", size = 1), xlab = " ", ylab = "Antworten Fragebogen", title = "Anthro1") + theme( plot.title = element_text(hjust = 0.5), text = element_text(size = 18))
plots[[2]] <- ggboxplot(stack(Anthro3), x = "ind", y = "values", add.params = list(color = "grey50", size = 1), xlab = " ", ylab = "Antworten Fragebogen", title = "Anthro3") + theme( plot.title = element_text(hjust = 0.5), text = element_text(size = 18))
plots[[3]] <- ggboxplot(stack(Anthro5), x = "ind", y = "values", add.params = list(color = "grey50", size = 1), xlab = " ", ylab = "Antworten Fragebogen", title = "Anthro5") + theme( plot.title = element_text(hjust = 0.5), text = element_text(size = 18))
plots[[4]] <- ggboxplot(stack(SocialPresence), x = "ind", y = "values", add.params = list(color = "grey50", size = 1), xlab = " ", ylab = "Antworten Fragebogen", title = "SocialPresence") + theme( plot.title = element_text(hjust = 0.5), text = element_text(size = 18))
plots[[5]] <- ggboxplot(stack(Agency), x = "ind", y = "values", add.params = list(color = "grey50", size = 1), xlab = " ", ylab = "Antworten Fragebogen", title = "Agency") + theme( plot.title = element_text(hjust = 0.5), text = element_text(size = 18))
plots[[6]] <- ggboxplot(stack(Attraktivitaet), x = "ind", y = "values", add.params = list(color = "grey50", size = 1), xlab = " ", ylab = "Antworten Fragebogen", title = "Attraktivit?t") + theme( plot.title = element_text(hjust = 0.5), text = element_text(size = 18))
plots[[7]] <- ggboxplot(stack(Kundenorientierung), x = "ind", y = "values", add.params = list(color = "grey50", size = 1), xlab = " ", ylab = "Antworten Fragebogen", title = "Kundenorientierung") + theme( plot.title = element_text(hjust = 0.5), axis.text.x = element_text(size = 13), text = element_text(size = 18))

j = 0
for (i in plots){
  j = j+1
  png(file=paste("~/", paste(j), "Boxplot2.png", sep=""),
      width=600, height=350)
  i
  dev.off()
}
